# PREVIEW-instance wrapper for the scores app -- see ../../shiny-server.conf.
#
# Same code as the public /scores (the apps_v8 checkout Shiny Server serves at
...
shiny::shinyAppDir("/srv/shiny-server/scores")
