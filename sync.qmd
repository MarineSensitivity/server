...
%%| fig-cap: "Overall server architecture showing developer laptop, GitHub (repos + container registry), external AWS server (Docker), and internal BOEM server (Podman) with container services and data flows."
%%| fig-width: 10
...
# install podman and podman-compose (RHEL 8)
...
sudo mkdir -p /share/data /share/public/www /share/github/MarineSensitivity /share/logs
```
...
%%| fig-cap: "Production server Podman services and data flow. Caddy serves static content and proxies Shiny. Data files are mounted as volumes."
%%| fig-width: 8
...
**Action**: confirm RHEL 8 version and ensure podman and podman-compose are installed and running.
